...
**Version v2025.11.11 · Released November 2025**
...
Projects must follow the required structure and be submitted as a `.zip` file through the questionnaire link. An official example project is available at [GitHub](https://github.com/ihainan/science_arena_challenge_example-submission).
...
Participants can use DeepSeek's official services ([deepseek-chat](https://api-docs.deepseek.com/) / [deepseek-reasoner](https://api-docs.deepseek.com/)) and Alibaba Cloud Bailian's [text-embedding-v4](https://bailian.console.aliyun.com/?tab=model#/model-market/detail/text-embedding-v4) model for local development and testing to keep interfaces consistent with the evaluation environment.
...
- Reference documentation:
  ...
  - [Alibaba Model Studio (Bailian) Embedding API](https://www.alibabacloud.com/help/en/model-studio/embedding)
  - [Example submission project](https://github.com/ihainan/science_arena_challenge_example-submission)
...
Participants can monitor standings at [http://39.97.229.86/leaderboard](http://39.97.229.86/leaderboard), which is updated continuously with the latest arena evaluations.
...
**Conference:** The 1st International Conference on AI Scientists (ICAIS) 2025
**Date:** November 23-25, 2025
**Location:** Beijing, China
**Contact:** service@icais.ai | icais@googlegroups.com
